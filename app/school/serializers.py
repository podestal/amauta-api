...
class ActivitySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'title', 'description', 'due_date', 'category', 'category_name', 'assignature', 'quarter', 'competences', 'capacities', 'content']
...
class GetActivityForTutorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.Activity
        fields = ['id', 'title', 'description', 'due_date', 'category', 'grade', 'observations', 'content']
